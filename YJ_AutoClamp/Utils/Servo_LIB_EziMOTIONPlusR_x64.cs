...
namespace YJ_AutoClamp.Utils.EzMotion_R
{
    public partial class EziMOTIONPlusRLib
    {
        ...
        //EZI_PLUSR_API int WINAPI		FAS_BrakeSet(BYTE nPortNo, BYTE iSlaveNo, BOOL bSet, int* nResult);
        [DllImport("EziMOTIONPlusRx64.dll")]
        public static extern int FAS_BrakeSet(byte nPortNo, byte iSlaveNo, int bSet, ref int nResult);
