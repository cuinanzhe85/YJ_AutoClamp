...
namespace YJ_AutoClamp.ViewModels
{
    public class SystemData_ViewModel : Child_ViewModel
    {
        ...
        private int _LiftCvStopDelay;
        public int LiftCvStopDelay
        {
            get { return _LiftCvStopDelay; }
            set { SetValue(ref _LiftCvStopDelay, value); }
        }
        public SystemData_ViewModel()
        {
            ...
            LiftCvStopDelay = SingletonManager.instance.SystemModel.LiftCvStopDelay;
        }
        private void OnSave_Command(object obj)
        {
            try
            {
                ...
                myIni.Write($"LIFT_CV_STOP_DELAY", LiftCvStopDelay.ToString(), Section);
                Global.Mlog.Info($" LIFT_CV_STOP_DELAY = " + LiftCvStopDelay);
                SingletonManager.instance.SystemModel.LiftCvStopDelay = LiftCvStopDelay;
